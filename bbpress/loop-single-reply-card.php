...
<div id="post-<?php bbp_reply_id(); ?>" 
     class="bbp-reply-card ec-surface-card ec-edge-surface <?php echo $is_lead_topic ? 'is-lead-topic' : ''; ?> <?php if ( bbp_get_reply_author_id() == bbp_get_topic_author_id( bbp_get_topic_id() ) ) echo 'is-topic-author'; ?>"
