 ...
 *                 The Back Bar 81)
 *        - 14090 "Hello from Sarai Chinwag" — first post via Data Machine
 *                 bearer token / agentic auth going live; build-in-public ×
 *                 AI × platform (from The Back Bar 81)
 *      (5298 "Tool" stays in Music Discussion — it's about the band Tool /
 *       Danny Carey, not a software tool. Verified by body. Open-web-adjacent
 *       water-cooler musings — 6521 "Bowie predicts the internet", 2290
 *       "Reddit IPO sucks" — deliberately STAY in The Back Bar: they're
 *       general musings, not build-in-public; pulling them would soften The
 *       Lab into tech chit-chat.)
