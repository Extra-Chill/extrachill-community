...
### Added
- add artist-tagged community discussions
...
### Added
- adopt canonical Local Scene

## [1.13.2] - 2026-07-12

### Fixed
- consume corrected ability client
...
### Fixed
- expose community-get-stats over REST for cross-site NetworkStats #140
...
### Fixed
- port @mentions completer from blocks-everywhere
...
### Fixed
- restore forum subscription gutter
...
### Changed
- standardize mobile edge classes
...
### Changed
- wrap forum description in page chrome
...
### Changed
- Use shared responsive tabs with mobile accordion settings
...
### Fixed
- Fix bbpress-editor jQuery dependency warning when theme deregisters jQuery
